...
- SYSTEM_PROMPT_FIRST_SEARCH        首次检索词（提示词列了 6 个 Tavily 工具，但解析层只取 search_query）
- SYSTEM_PROMPT_FIRST_SUMMARY       段落初稿（新闻分析，≥800-1200 字）
- SYSTEM_PROMPT_REFLECTION          反思检索词
- SYSTEM_PROMPT_REFLECTION_SUMMARY  反思增补段落
- SYSTEM_PROMPT_REPORT_FORMATTING   汇总成最终 Markdown（新闻调查报告风格）
