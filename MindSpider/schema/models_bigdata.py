...
class TwitterTweet(Base):
    ...
    nickname: Mapped[str | None] = mapped_column(Text, nullable=True)
    avatar: Mapped[str | None] = mapped_column(Text, nullable=True)
    user_verified: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    user_verified_type: Mapped[str | None] = mapped_column(String(32), default='', nullable=True)
    ip_location: Mapped[str | None] = mapped_column(Text, default='', nullable=True)
    add_ts: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    last_modify_ts: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    tweet_id: Mapped[str] = mapped_column(String(255), index=True, unique=True, nullable=False)
    tweet_type: Mapped[str | None] = mapped_column(String(32), default='tweet', nullable=True)
    content: Mapped[str | None] = mapped_column(Text, nullable=True)
    create_time: Mapped[int | None] = mapped_column(BigInteger, index=True, nullable=True)
    create_date_time: Mapped[str | None] = mapped_column(String(255), nullable=True)
    like_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
    retweet_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
    reply_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
    quote_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
    bookmark_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
    view_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
    ...
    is_retweet: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    retweeted_tweet_id: Mapped[str | None] = mapped_column(String(255), default='', nullable=True)
    retweeted_user_id: Mapped[str | None] = mapped_column(String(255), default='', nullable=True)
    is_quote: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    quoted_tweet_id: Mapped[str | None] = mapped_column(String(255), default='', nullable=True)
    quoted_user_id: Mapped[str | None] = mapped_column(String(255), default='', nullable=True)
    is_reply: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    reply_to_tweet_id: Mapped[str | None] = mapped_column(String(255), default='', nullable=True)
    reply_to_user_id: Mapped[str | None] = mapped_column(String(255), default='', nullable=True)
    tweet_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    source_keyword: Mapped[str | None] = mapped_column(Text, default='', nullable=True)
    lang: Mapped[str | None] = mapped_column(String(16), default='', nullable=True)
    topic_id: Mapped[str | None] = mapped_column(String(64), ForeignKey("daily_topics.topic_id", ondelete="SET NULL"), nullable=True)
    crawling_task_id: Mapped[str | None] = mapped_column(String(64), ForeignKey("crawling_tasks.task_id", ondelete="SET NULL"), nullable=True)
...
class TwitterTweetComment(Base):
    ...
    add_ts: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    last_modify_ts: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    comment_id: Mapped[str] = mapped_column(String(255), index=True, unique=True, nullable=False)
    tweet_id: Mapped[str] = mapped_column(String(255), index=True, nullable=False)
    content: Mapped[str | None] = mapped_column(Text, nullable=True)
    create_time: Mapped[int | None] = mapped_column(BigInteger, index=True, nullable=True)
    create_date_time: Mapped[str | None] = mapped_column(String(255), nullable=True)
    like_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
...
class TwitterCreator(Base):
    ...
    join_date: Mapped[str | None] = mapped_column(String(255), nullable=True)
    verified: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    verified_type: Mapped[str | None] = mapped_column(String(32), default='', nullable=True)
    protected: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    followers_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
    following_count: Mapped[str | None] = mapped_column(String(64), default='0', nullable=True)
...
class SANewsArticle(Base):
    ...
    translation_status: Mapped[str | None] = mapped_column(String(16), default='pending', index=True, nullable=True)
    translation_provider: Mapped[str | None] = mapped_column(String(64), nullable=True)
    translation_ts: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    translation_input_tokens: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    translation_output_tokens: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    translation_cost: Mapped[str | None] = mapped_column(String(32), nullable=True)
    translation_duration_ms: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    # 翻译质量评估字段
    eval_accuracy: Mapped[int | None] = mapped_column(Integer, nullable=True)
    eval_fluency: Mapped[int | None] = mapped_column(Integer, nullable=True)
    eval_terminology: Mapped[int | None] = mapped_column(Integer, nullable=True)
    eval_completeness: Mapped[int | None] = mapped_column(Integer, nullable=True)
    eval_overall: Mapped[int | None] = mapped_column(Integer, nullable=True)
    eval_comment: Mapped[str | None] = mapped_column(Text, nullable=True)
    eval_provider: Mapped[str | None] = mapped_column(String(64), nullable=True)
    eval_ts: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
